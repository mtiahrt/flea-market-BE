...
INSERT INTO public.item_image (id, sale_item_id, url) values
...
INSERT INTO public.sale_item (id, subcategory_id, name, description, manufacturer_name, price) VALUES
...
INSERT INTO public.subcategory (id, category_id, name, description) VALUES
...
SELECT pg_catalog.setval('public.category_id_seq', 8, false);



SELECT pg_catalog.setval('public.item_image_id_seq', 3, true);


SELECT pg_catalog.setval('public.sale_item_id_seq', 39, true);


SELECT pg_catalog.setval('public.subcategory_id_seq', 30, true);
...
CREATE TRIGGER sale_item_inserts AFTER INSERT ON public.sale_item FOR EACH ROW EXECUTE
